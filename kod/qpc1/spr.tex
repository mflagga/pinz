...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{dyspfile.png}
...
Ze względu na to jak zdefiniowany był nasz problem interesuje nas jedynie połowa wartości i wektorów (skróconych o połowę) własnych.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{popU.png}
...
\begin{figure*}[t]
    \begin{subfigure}[t]{\linewidth}
        \centering
        \includegraphics[width=0.6\linewidth]{lfile.png}
        \label{lfile}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{uRe.png}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{uIm.png}
